...
## About The Project:
As I was creating the sample of hamburger navigation bar, I used HTML, CSS, and Vanilla JS. You can use this project as a basis and whenever you need Hamburger Nav Menu you can just copy paste the code and just change the appearance of it if you would.
